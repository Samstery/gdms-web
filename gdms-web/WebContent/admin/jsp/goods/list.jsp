...
function xiugai(a){
	...
	//对tr中中间的几个能修改的单元格进行文本替换
	var $td3 =$($tr.children("td")[2]);//取得第3个文本值
	var $td4 =$($tr.children("td")[3]);//取得第4个文本值
	var $td5 =$($tr.children("td")[4]);//取得第5个文本值
	var $td6 =$($tr.children("td")[5]);//取得第6个文本值
